...
def greet_user(name):
    print(f" Hello {name}!,we love having you.I am your AI Buddy.Remember, I am a motivational bot that helps break unconfident or negative thought patterns to help you regain your spark. We do not diagnose or treat mental health symptoms or conditions. We are all about confidence building and boosting.\
    Type quit to exit")
...
def main():
    ...
    name =  st.chat_input("Hope you are well ! Please type your name to begin. ")
    greet_user(name)
